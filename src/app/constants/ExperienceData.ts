...
export const experienceData: ExperienceDataProps[] = [
  {
    ...
    description: [
      "Developing the marketing website for <a href='https://www.editonthespot.com/' target='_blank' >https://editonthespot.com</a> using Next.js with TypeScript and Chakra-UI",
