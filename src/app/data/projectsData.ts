export const projectsData = [
  {
    ...
    content:
      "This waveform editor displays an audio clip in two waveforms, an overview of the entire media and a zoom view of a selected section of the media. The waveform is presented either pre-populated with clips/segments or displayed with no clips/segments. A user can add more clips/segments to the timeline whether it is pre-populated or empty. All clips can be edited, deleted or created once the user is ready. Clip information is displayed in a list below the waveform",
